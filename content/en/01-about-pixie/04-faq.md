...
If specific services / requests are missing, it is possible that your application was not built with [debug symbols](/reference/admin/debug-symbols). See the [Data Sources](/about-pixie/data-sources) page too see which protocols and/or encryption libraries require a build with debug symbols.
