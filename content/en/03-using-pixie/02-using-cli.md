...
Pixie offers end-to-end encryption for telemetry data requested by the CLI. For more information, see the [FAQ](/about-pixie/#data-collection-how-does-pixie-secure-its-data).
